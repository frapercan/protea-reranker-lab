...
Typical usage::
    ...
    result = bootstrap_paired_fmax(
        ...
        source_eval_parquet=Path("datasets/bench-v1-K5-v226-lineage/eval.parquet"),
...
``bench-v1-K5-v226-lineage``, NK+LK cells only. Six NK+LK confidence
intervals are all strictly positive at the 95% level (N=10000 bootstrap
iterations). This is the number cited in Chapter 6 of the doctoral
thesis.
