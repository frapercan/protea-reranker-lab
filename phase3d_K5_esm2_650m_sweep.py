...
Writes:
  - runs/phase3d_K5_esm2_650m/<cell>_seed<n>/run.json (training artefact)
  - runs/phase3d_K5_esm2_650m/<cell>_seed<n>/cafaeval_metrics.json
  - runs/phase3d_K5_esm2_650m/cis.json (per-cell bootstrap 95% CIs)
  - runs/phase3d_K5_esm2_650m/paired_ci.json (v27 vs v22 paired bootstrap)
...
RUNS_ROOT = WORKTREE / "runs" / "phase3d_K5_esm2_650m"
...
def _make_spec_yaml(cell: str, seed: int, out_dir: Path) -> Path:
    spec = {
        "schema_version": "v1",
        "name": f"phase3d_K5_esm2_650m_{cell}_seed{seed}",
        "dataset": {
...
def write_summary_md(
    ...
    lines += [
        ...
        "Artifact root: runs/phase3d_K5_esm2_650m/",
    ]
