...
S = Path('/home/frapercan/Thesis2/storage/cooc_experiment')
TRAIN = Path('/home/frapercan/Thesis2/repositories/protea-reranker-lab/datasets/protst-global-train227-test230/train.parquet')
EVAL = Path('/home/frapercan/Thesis2/repositories/protea-reranker-lab/datasets/protst-global-train227-test230/eval.parquet')
OUT = S / "rerank_out"
...
PARAMS = {
    ...
    "verbose": -1,
    "num_threads": 12,
    # Memory: the pk cell is 25.9M x 72 and peaked at 53GB RSS (of 62G) with the
    # defaults, which OOM-killed the run. max_bin 63 (from 255) + two_round keep the
    # binned dataset small enough to finish with headroom; the accuracy cost is
    # negligible for a ranking model and both arms of the experiment share it.
    "max_bin": 63,
    "two_round": True,
    "force_col_wise": True,
}
