...
Usage:
  python train_ab.py <train.parquet> <eval.parquet> <out_dir> <armA|armB>
...
def main():
    feats = feature_cols()
    print(f"ARM={ARM} n_features={len(feats)} has_protst={sorted(PROTST_COLS & set(feats))}", flush=True)
