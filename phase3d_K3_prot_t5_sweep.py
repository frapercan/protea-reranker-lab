...
Writes:
  - runs/phase3d_K3_prot_t5/<cell>_seed<n>/run.json (training artefact)
  - runs/phase3d_K3_prot_t5/<cell>_seed<n>/cafaeval_metrics.json
  - runs/phase3d_K3_prot_t5/cis.json (per-cell bootstrap 95% CIs)
  - runs/phase3d_K3_prot_t5/paired_ci.json (v27 vs v22 paired bootstrap)
...
RUNS_ROOT = WORKTREE / "runs" / "phase3d_K3_prot_t5"
...
def _make_spec_yaml(cell: str, seed: int, out_dir: Path) -> Path:
    spec = {
        "schema_version": "v1",
        "name": f"phase3d_K3_prot_t5_{cell}_seed{seed}",
        "dataset": {
...
def write_summary_md(
    ...
    lines += [
        ...
        "Artifact root: runs/phase3d_K3_prot_t5/",
    ]
