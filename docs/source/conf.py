...
# Generate implicit slug anchors for headings (levels 1-3) so the
# in-page Markdown links in spec_catalog.md (e.g. ``[study-v22](#study-v22)``)
# resolve to their GitHub-style heading slugs under MyST.
