...
def run(args: argparse.Namespace) -> dict:
    ...
    for metric in ("resnik", "lin"):
        ...
        for k in args.kwta_k:
            ...
            # DECOMPOSITION LADDER on the dense mean (isolate sparsity vs binarization).
            # A = full real cosine (rho_cos). B = top-k REAL cosine (sparsity only).
            # C = top-k BINARY cosine (+ binarization). At fixed k, binary cosine and Tanimoto
