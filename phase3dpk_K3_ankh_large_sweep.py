...
across seeds 42, 137, 244 for all NK+LK cells on bench-v1-K3-v226-lineage-ankh_large.
Seeds match the v27 target set; compare against v22 (LB.2) baseline for thesis Ch.6.

Writes:
  - runs/phase3dpk_K3_ankh_large/<cell>_seed<n>/run.json (training artefact)
  - runs/phase3dpk_K3_ankh_large/<cell>_seed<n>/cafaeval_metrics.json
  - runs/phase3dpk_K3_ankh_large/cis.json (per-cell bootstrap 95% CIs)
  - runs/phase3dpk_K3_ankh_large/paired_ci.json (v27 vs v22 paired bootstrap)
...
DATASET_DIR = REPO_DATASETS / "bench-v1-K3-v226-lineage-ankh_large"
OBO_PATH = REPO_DATASETS / "bench-v1-K5" / "go.obo"
RUNS_ROOT = WORKTREE / "runs" / "phase3dpk_K3_ankh_large"
...
V26_HPARAMS = {
    ...
    "drop_features": ["anc2vec_has_emb", "anc2vec_neighbor_cos", "anc2vec_neighbor_maxcos", "anc2vec_query_known_cos", "anc2vec_query_known_count", "anc2vec_query_known_maxcos", "emb_pca_query_0", "emb_pca_query_1", "emb_pca_query_2", "emb_pca_query_3", "emb_pca_query_4", "emb_pca_query_5", "emb_pca_query_6", "emb_pca_query_7", "emb_pca_query_8", "emb_pca_query_9", "emb_pca_query_10", "emb_pca_query_11", "emb_pca_query_12", "emb_pca_query_13", "emb_pca_query_14", "emb_pca_query_15", "lineage_ancestor_of_count", "lineage_descendant_of_count", "lineage_is_ancestor_of_known", "lineage_is_descendant_of_known", "tax_voters_close_frac", "tax_voters_mean_common_ancestors", "tax_voters_same_frac"],  # lean+lin+emb = all 56 features; no drops
}
...
def _make_spec_yaml(cell: str, seed: int, out_dir: Path) -> Path:
    spec = {
        "schema_version": "v1",
        "name": f"phase3dpk_K3_ankh_large_{cell}_seed{seed}",
        "dataset": {
        ...
        "tags": [
            "bench-v1-K3-v226-lineage-ankh_large",
            cell,
            f"seed{seed}",
            "study_phase3dpk_K3_ankh_large",
            "binary_objective",
            "lean_lin_emb",
            "neg_pos_10",
        ],
...
def write_summary_md(
    ...
    lines = [
        ...
        "Eval set: bench-v1-K3-v226-lineage-ankh_large (eval window v226-v230).",
    ...
    lines += [
        ...
        "Artifact root: runs/phase3dpk_K3_ankh_large/",
    ]
