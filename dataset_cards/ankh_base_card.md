...
tags:
  ...
  - lightgbm
  - benchmark
pretty_name: "bench-v1 v226-lineage ankh_base (K=3,5,10)"
zenodo_doi: TBD
---

# bench-v1-K{3,5,10}-v226-lineage-ankh_base

Dataset family produced by PROTEA's `export_research_dataset` operation
for the Ankh-base protein language model. Each cell in the K axis is a
...
| --- | --- |
| PLM key | `ankh_base` |
| HuggingFace checkpoint | `ElnaggarLab/ankh-base` |
| Architecture | Ankh-base (T5 backbone) |
| Embedding dimension (raw) | 768 |
...
| Embedding config id | `08234f06-ba76-4d7d-aaec-ae601096b4fa` |

Note: an experimental multi-layer ablation config (`c2868c1a`,
layers 0,1,2 with normalize_residues=true) exists but is not part
of the canonical 8-PLM protocol (ADR D35). This card covers only the
canonical single-layer mean-pool config.
...
| --- | --- | --- | --- | --- |
| bench-v1-K3-v226-lineage-ankh_base | TBD | TBD | 6d97a624b8a7 | Pending EXP.13 completion |
| bench-v1-K5-v226-lineage-ankh_base | TBD | TBD | 6d97a624b8a7 | Pending EXP.13 completion |
| bench-v1-K10-v226-lineage-ankh_base | 32,729,044 | 1,467,902 | 6d97a624b8a7 | Available |

Note: K3 and K5 row counts will be updated once EXP.13 finishes.
...
**K3 and K5 cells pending.** Row counts are placeholders. Final
