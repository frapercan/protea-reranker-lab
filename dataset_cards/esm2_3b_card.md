...
tags:
  ...
  - lightgbm
  - benchmark
pretty_name: "bench-v1 v226-lineage esm2_3b (K=3,5,10)"
zenodo_doi: TBD
---

# bench-v1-K{3,5,10}-v226-lineage-esm2_3b

Dataset family produced by PROTEA's `export_research_dataset` operation
for the ESM-2 3B protein language model. Each cell in the K axis is a
...
| --- | --- |
| PLM key | `esm2_3b` |
| HuggingFace checkpoint | `facebook/esm2_t36_3B_UR50D` |
| Architecture | ESM-2 (transformer encoder, 36 layers) |
| Embedding dimension (raw) | 2560 |
...
| --- | --- | --- | --- | --- |
| bench-v1-K3-v226-lineage-esm2_3b | TBD | TBD | 6d97a624b8a7 | Pending EXP.13 completion |
| bench-v1-K5-v226-lineage-esm2_3b | 24,547,249 | 1,081,671 | 6d97a624b8a7 | Available |
| bench-v1-K10-v226-lineage-esm2_3b | 34,622,201 | 1,551,420 | 6d97a624b8a7 | Available |
...
Approximately 551,918 proteins with embeddings stored under
`embedding_config_id = 55e43f1c-1a3b-4b1d-88c0-26b433f5f673`.
