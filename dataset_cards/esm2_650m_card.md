...
tags:
  ...
  - lightgbm
  - benchmark
pretty_name: "bench-v1 v226-lineage esm2_650m (K=3,5,10)"
zenodo_doi: TBD
---

# bench-v1-K{3,5,10}-v226-lineage-esm2_650m

Dataset family produced by PROTEA's `export_research_dataset` operation
for the ESM-2 650M protein language model. Each cell in the K axis is a
...
| --- | --- |
| PLM key | `esm2_650m` |
| HuggingFace checkpoint | `facebook/esm2_t33_650M_UR50D` |
| Architecture | ESM-2 (transformer encoder, 33 layers) |
| Embedding dimension (raw) | 1280 |
...
| Embedding config id | `c2e9dda3-e505-4170-b50d-435a451761ac` |
...
| --- | --- | --- | --- | --- |
| bench-v1-K3-v226-lineage-esm2_650m | 20,428,462 | 888,943 | 6d97a624b8a7 | Available |
| bench-v1-K5-v226-lineage-esm2_650m | 24,921,117 | 1,092,281 | 6d97a624b8a7 | Available |
| bench-v1-K10-v226-lineage-esm2_650m | 35,580,693 | 1,590,580 | 6d97a624b8a7 | Available |
...
Approximately 527,422 proteins with embeddings stored under
`embedding_config_id = c2e9dda3-e505-4170-b50d-435a451761ac`.
...
category-bucket effect. Consumers training on this dataset inherit that
fix. See memory `anc2vec-leakage-mechanism`.
