...
across seeds 42, 137, 244 for all NK+LK cells on bench-v1-K10-v226-lineage-esm2_650m.
Seeds match the v27 target set; compare against v22 (LB.2) baseline for thesis Ch.6.

Writes:
  - runs/phase3dpk_K10_esm2_650m/<cell>_seed<n>/run.json (training artefact)
  - runs/phase3dpk_K10_esm2_650m/<cell>_seed<n>/cafaeval_metrics.json
  - runs/phase3dpk_K10_esm2_650m/cis.json (per-cell bootstrap 95% CIs)
  - runs/phase3dpk_K10_esm2_650m/paired_ci.json (v27 vs v22 paired bootstrap)
...
DATASET_DIR = REPO_DATASETS / "bench-v1-K10-v226-lineage-esm2_650m"
OBO_PATH = REPO_DATASETS / "bench-v1-K5" / "go.obo"
RUNS_ROOT = WORKTREE / "runs" / "phase3dpk_K10_esm2_650m"
...
def _make_spec_yaml(cell: str, seed: int, out_dir: Path) -> Path:
    spec = {
        "schema_version": "v1",
        "name": f"phase3dpk_K10_esm2_650m_{cell}_seed{seed}",
        "dataset": {
...
def write_summary_md(
    ...
    lines = [
        ...
        "Eval set: bench-v1-K10-v226-lineage-esm2_650m (eval window v226-v230).",
    ...
    lines += [
        ...
        "Artifact root: runs/phase3dpk_K10_esm2_650m/",
    ]
