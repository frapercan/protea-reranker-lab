...
Writes:
  - runs/phase3a_K5_esm2_3b/<cell>_seed<n>/run.json (training artefact)
  - runs/phase3a_K5_esm2_3b/<cell>_seed<n>/cafaeval_metrics.json
  - runs/phase3a_K5_esm2_3b/cis.json (per-cell bootstrap 95% CIs)
  - runs/phase3a_K5_esm2_3b/paired_ci.json (v27 vs v22 paired bootstrap)
...
RUNS_ROOT = WORKTREE / "runs" / "phase3a_K5_esm2_3b"
...
def _make_spec_yaml(cell: str, seed: int, out_dir: Path) -> Path:
    spec = {
        "schema_version": "v1",
        "name": f"phase3a_K5_esm2_3b_{cell}_seed{seed}",
        "dataset": {
...
def write_summary_md(
    ...
    lines += [
        ...
        "Artifact root: runs/phase3a_K5_esm2_3b/",
    ]
