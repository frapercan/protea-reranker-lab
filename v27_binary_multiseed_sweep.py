...
Writes:
  - runs/v27_binary_multiseed/<cell>_seed<n>/run.json (training artefact)
  - runs/v27_binary_multiseed/<cell>_seed<n>/cafaeval_metrics.json
  - runs/v27_binary_multiseed/cis.json (per-cell bootstrap 95% CIs)
  - runs/v27_binary_multiseed/paired_ci.json (v27 vs v22 paired bootstrap)
...
def _make_spec_yaml(cell: str, seed: int, out_dir: Path) -> Path:
    spec = {
        "schema_version": "v1",
        "name": f"v27_binary_multiseed_{cell}_seed{seed}",
        "dataset": {
