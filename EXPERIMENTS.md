...
eval=bench-v1-K5-v226-lineage, prop=fill, ens=none`) supersedes the
...
`bench-v1-K5-v226-lineage` (eval `v226-v230`), placing the historical
...
1. The eval distribution shifted from the unknown pre-leakage-fix
   range to `bench-v1-K5-v226-lineage` (eval v226-v230). The legacy
...
2. The leakage source (anc2vec_* + emb_pca_* feature families) was
   ...
   `bench-v1-K5-v226-lineage` (see the lineage-feature studies
